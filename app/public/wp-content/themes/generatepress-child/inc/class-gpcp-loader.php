...
class GPCP_Loader
{
    ...
    {
        // Admin class
        require_once GPCP_THEME_DIR . '/inc/admin/class-gpcp-admin.php';
        ...
        foreach ($modules as $module => $file) {
            $file_path = GPCP_THEME_DIR . '/inc/modules/' . $file;
        ...
        // SEO Manager
        if (file_exists(GPCP_THEME_DIR . '/inc/admin/class-gpcp-seo-manager.php')) {
            require_once GPCP_THEME_DIR . '/inc/admin/class-gpcp-seo-manager.php';
        }
    }
