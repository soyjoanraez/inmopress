...
<div class="inmopress-property-card inmopress-property-card-grid">
    <div class="property-image-wrapper">
        <?php if (has_post_thumbnail($post_id)) : ?>
            <a href="<?php echo esc_url(get_permalink($post_id)); ?>" class="property-image-link">
                <?php echo get_the_post_thumbnail($post_id, 'medium_large', array('class' => 'property-image', 'loading' => 'lazy')); ?>
            </a>
        <?php else : ?>
    ...
    <div class="property-content">
        <?php if (in_array('titulo_seo', $visible_fields) || in_array('referencia', $visible_fields)) : ?>
