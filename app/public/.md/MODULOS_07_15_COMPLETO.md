...
**NOTA:** El Motor de Automatizaciones está integrado en `inmopress-core`, NO existe como plugin separado.
...
│   ├── class-automations.php          (Integración legacy)
│   └── ... (otras clases del core)
└── admin/
    └── (vistas de automatizaciones integradas en admin del core)
```
...
**NOTA:** La Integración IA + SEO está integrada en `inmopress-core`, NO existe como plugin separado.

```
inmopress-core/
├── inmopress-core.php
├── includes/
│   ├── class-inmopress-ai.php         (~1,800 líneas)
│   │   ├── AI Client (OpenAI)
│   │   ├── Content Generator
...
│   └── ... (otras clases del core)
└── admin/
    └── (metaboxes y configuraciones integradas en admin del core)
```
